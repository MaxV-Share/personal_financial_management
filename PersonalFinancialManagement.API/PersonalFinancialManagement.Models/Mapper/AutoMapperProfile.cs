...
namespace PersonalFinancialManagement.Models.Mapper;
...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        CreateMap<RawTransaction, RawTransactionViewModel>().ReverseMap();
        CreateMap<RawTransaction, RawTransactionUpdateRequest>().ReverseMap();
        CreateMap<RawTransaction, RawTransactionCreateRequest>().ReverseMap();
        CreateMap<RawTransactionCreateRequest, RawTransactionViewModel>().ReverseMap();
    }
}