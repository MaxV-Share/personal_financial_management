    ...
    UserLogin, RoleClaim, UserToken>
{
    ...
    public virtual DbSet<TransactionCategory> TransactionCategories { set; get; } = null!;
    public virtual DbSet<Transaction> Transactions { set; get; } = null!;
    public virtual DbSet<Currency> Currencies { set; get; } = null!;
    public virtual DbSet<PaymentAccountType> PaymentAccountTypes { set; get; } = null!;
    public virtual DbSet<PaymentAccount> PaymentAccounts { set; get; } = null!;
    public virtual DbSet<RawTransaction> RawTransactions { set; get; } = null!;
